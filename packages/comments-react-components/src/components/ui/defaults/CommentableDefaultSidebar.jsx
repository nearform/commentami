...
import { CommentableCommentsList } from '../CommentableCommentsList'
import { CommentableIcon } from '../CommentableIcon'
import { CommentableNewForm } from '../CommentableNewForm'

export class CommentableDefaultSidebar extends React.Component {
  constructor(props) {
    super(props)
  ...
  handleClose(ev) {
    ...
    const payload = { resource: controller.resource, reference: controller.reference, ref: this.rootRef, scope: 'sidebar-close' }
