...
describe('NewCommentForm', () => {
  describe('.render', () => {
    test('should render the core elements', () => {
      const wrapper = mount(withCommentableContext(<NewCommentForm reference="REFERENCE" />))
  ...
  describe('submitting', () => {
    test('should submit when clicking on the button', () => {
      ...
      const wrapper = mount(withCommentableContext(<NewCommentForm reference="REFERENCE" addComment={addComment} />))
